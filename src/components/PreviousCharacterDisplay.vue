  ...
  <div>
    ...
    <div class="row">
      <div class="col-6">
        ...
        <br />
        <button v-on:click="Retrieve" id="retrieveCharacterButton">
          Retrieve This Character From Datatabase
        </button>
        <button v-on:click="charUpdateDisplay">
          Update This Character in the Datatabase
        </button>
      ...
      <div class="col-6">
        ...
        <button v-on:click="Delete">
          Delete This Character From Datatabase
        </button>
      </div>
    </div>
  </div>
