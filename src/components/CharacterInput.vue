  ...
  <div>
    ...
    <div>
      ...
      <div v-if="this.charRace === 'Human'">
        <p>
          Humans get a +2 Bonus to any 1 stat, please select the stat and see
          the bonus upon changing the value.
        </p>
...
export default {
  ...
  methods: {
    ...
    calcStr: function() {
      this.remAbilityPoints =
        this.remAbilityPoints + this.scoreObj[this.rawStr] - this.Str;
    ...
    calcDex: function() {
      this.remAbilityPoints =
        this.remAbilityPoints + this.scoreObj[this.rawDex] - this.Dex;
    ...
    calcCon: function() {
      this.remAbilityPoints =
        this.remAbilityPoints + this.scoreObj[this.rawCon] - this.Con;
    ...
    calcInt: function() {
      this.remAbilityPoints =
        this.remAbilityPoints + this.scoreObj[this.rawInt] - this.Int;
    ...
    calcWis: function() {
      this.remAbilityPoints =
        this.remAbilityPoints + this.scoreObj[this.rawWis] - this.Wis;
    ...
    calcCha: function() {
      this.remAbilityPoints =
        this.remAbilityPoints + this.scoreObj[this.rawCha] - this.Cha;
